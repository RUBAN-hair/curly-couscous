...
(function() {
  'use strict';
  var $document, $window, _bpush, _prevScrollTop, _prevScrollUp, doNotAffixHeight, element, i, isDebug, isSP, isSupportPushNotification, len, ref, ref1, scrollStopEvent, throttle;
  ...
  isSP = !$window.matchMedia("(min-width: 600px)").matches;
  ...
  if ((element != null ? element.webkitSpeech : void 0) !== null) {
    element.setAttribute('x-webkit-speech', true);
  }

  element = $document.getElementById('search-button');

  if (element != null) {
    element.setAttribute('onClick', 'return _cse()');
  }
